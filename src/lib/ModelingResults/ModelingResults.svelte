...
<html lang='en'>
    ...
    <h4 class="text-3xl py-4 font-medium">Primary occupation type</h4>
        <p class="text-left">
            Clerical Support Workers (p = 0.0245)<br>Service and Sales Workers (p = 0.0417)
        </p>
    <h4 class="text-3xl py-4 font-medium">Primary occupation industry type</h4>
        <p class="text-left">
            Wholesale and Retail Trade; Repair of Motor Vehicles* (p = 00014)
            <br>Human Health and Social Work Activities (p = 0.0479)
        </p>
    <h4 class="text-3xl py-4 font-medium">Class of worker</h4>
        <p class="text-left">
            Private household (p = 0.0281)
            <br>Without pay (Family-owned business) (p = 0.0005)**
        </p>

    <p class="text-left">Meanwhile, women are significantly outnumbered in the following:</p>
    <h4 class="text-3xl py-4 font-medium">Primary Occupation Type</h4>
        <p class="text-left">
            Skilled Agricultural, Forestry and Fishery Workers** (p = 0.0002)
            <br>Craft and Related Trades Workers* (p = 0.0030)
            <br>Plant and Machine Operators and Assemblers** (p = 0.0001)
        </p>
    <h4 class="text-3xl py-4 font-medium">Primary Occupation Industry Type</h4>
        <p class="text-left">
            Agriculture and Forestry** (p = 0.0004)
            <br>Fishing and Aquaculture (p = 0.0580)
            <br>Construction** (p = 0.0001)
            <br>Transportation and Storage** (p = 0.0001)
        </p>
    <h4 class="text-3xl py-4 font-medium">Class of Worker</h4>
        <p class="text-left">Private Establishment** (p = 0.0001)</p>
